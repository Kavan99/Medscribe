...
GEMINI_API_KEY = "AIzaSyCAEx3HSa4o_KvUIalYawBxTaOGIsVci1k"
app = FastAPI()
...
async def transcribe_audio(audio: UploadFile = File(...)):
    try:
        ...
        try:
            ...
            client = Groq(api_key="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")
    ...
    try:
        ...
        try:
            ...
            gemini = ChatGoogleGenerativeAI(
                ...
                api_key="AIzaSyCAEx3HSa4o_KvUIalYawBxTaOGIsVci1k",
                temperature=0.3
            )
...
def generate_prescription(transcript: str) -> str:
    try:
        ...
        mistral_large = ChatMistralAI(
            ...
            api_key="BJXH9apHgJInyLLNJtq0iElPd35EpWy8",
            temperature=0.3
        )
