            ...
            <div className="grid md:grid-cols-2 gap-8">
              ...
              <div className="relative group">
                ...
                <div className="relative bg-gray-900/80 backdrop-blur-sm p-6 rounded-xl h-full transform group-hover:translate-y-[-5px] transition-all duration-300">
                  ...
                  <p className="text-gray-400 group-hover:text-gray-300 transition-colors">
                    Passionate about problem-solving in a creative way. I am the Convener of Tinkerers' Lab, IITB. Have worked on several robotic projects, to name a few - POV display, automatic potentiometric titrator, etc.
                  </p>
                </div>
              </div>
            </div>
